            ...
            <div>
              ...
              <div>
                <div class="flex sm:gap-5">
                  <button
                    class="w-full inline-flex items-center justify-center gap-3 py-3 text-sm font-normal text-gray-700 transition-colors bg-gray-100 rounded-lg px-7 hover:bg-gray-200 hover:text-gray-800 dark:bg-white/5 dark:text-white/90 dark:hover:bg-white/10"
                  >
                    <svg
                      width="20"
                      height="20"
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div
                      v-if="errorMessage"
                      class="p-3 mb-4 text-sm text-red-600 bg-red-100 rounded-lg"
                    >
                      {{ errorMessage }}
                    </div>
                    <!-- Button -->
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">
                Gestão inteligente para ministérios fortes, organizando a Igreja com excelência.
              </p>
            </div>
          </div>
        </div>
...
const handleSubmit = async () => {
  try {
    ...
    // Redirecionar para a dashboard ou home após o login
